...
export const DEVICE_LOCATION_VERIFICATION_API: Api={
    id: "device-location-verification",
            ...
            content: [
                {
                    ...
                    image: 'assets/images/device-location-verification/usecase1.jpg'
                },
                {
                    ...
                    image: 'assets/images/device-location-verification/usecase2.jpg'
                }]
            },
        // caseStudies: {
        //     title: "Case studies",
    ...
    documentation:{
        ...
        functionality: {
            ...
            /verify : Verify whether the location of a device is within a requested area. The operation returns a verification result and, optionally, a match rate estimation for the location verification in percent.`
        },
        authorization: {
        ...
        sandboxSwagger: "/assets/images/device-location-verification/openapi.json"
    },
    sandbox:{
        sandboxUrl:"#"
    },
